...
4. [Question 2: Who is using cash?](#part4)
...
#ifelse() command use the same order as it looks in dataframe excute 
#cols <- ifelse(ft_freq_df$faretype == "Cash", "red","gray50")

#set the specific color for cash
cashasred <- scale_fill_manual(values=c("Cash" = "Red","Free"="gray50","Other"="gray50","Train Ticket, Day Pass"="gray50","ORCA day pass"="gray50","Train Ticket, One Way"="gray50","U-PASS ORCA"="gray50","ORCA e-purse"="gray50","ORCA, as pass"="gray50"))

#something wrong with color, fix now
#faretypeColors <- scale_fill_manual(values = c("Cash" = "red"))
...
#ifelse() command use the same order as it looks in dataframe excute 
#cols2 <- ifelse(dfFarePurpose$Faretype == "Cash", "red","gray50")
...
From our regression, we can see that compared with reference group, people in the highest income group are less likely to use cash to pay transit fees, people whose purpose is home based work trip have less probability using cash, while people whose purpose is non-home based trip is more likely to use cash.
